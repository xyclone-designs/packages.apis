...
namespace XycloneDesigns.Apis.IEC.Http.Rest
{
	public partial class VotingDistricts 
	{
		...
		{
			public Response() { }
			public Response(Request request, IQueryable<VotingDistrict> queryable)
			{
			...
			public IQueryable<VotingDistrict> Filter(Request request, IQueryable<VotingDistrict> queryable)
			{

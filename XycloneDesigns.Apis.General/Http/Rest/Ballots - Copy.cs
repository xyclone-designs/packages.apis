...
namespace XycloneDesigns.Apis.IEC.Http.Rest
{
	public partial class Ballots 
	{
		public class OrderKeys : IECRest.OrderKeys
		{
			...
			public static IOrderedQueryable<Ballot> Order(IQueryable<Ballot> queryable, string orderkey, bool reverse)
			{
			...
			public static IQueryable<Ballot> Order(IQueryable<Ballot> queryable, bool reverse, params string[] orderkeys)
			{
				IOrderedQueryable<Ballot>? ordered = null;

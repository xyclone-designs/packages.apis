...
namespace XycloneDesigns.Apis._Tests.MunicipalMoney
{
	public class GlobalsMunicipalMoney
	{
		...
		public static readonly IEnumerable<object[]> CubeNamesDemarcated = _CubeNames.SelectMany(_ => _ switch
		{
			Cube.Names.AgedCreditorAnalysis => AgedCreditorAnalysis.KeysEnumerable.Select(__ => new string[] { _, __ }).ToArray(),
			Cube.Names.AgedCreditorAnalysisV2 => AgedCreditorAnalysisV2.KeysEnumerable.Select(__ => new string[] { _, __ }).ToArray(),
			Cube.Names.AgedDebtorAnalysis => AgedDebtorAnalysis.KeysEnumerable.Select(__ => new string[] { _, __ }).ToArray(),
			Cube.Names.AgedDebtorAnalysisV2 => AgedDebtorAnalysisV2.KeysEnumerable.Select(__ => new string[] { _, __ }).ToArray(),
			Cube.Names.AuditOpinions => AuditOpinions.KeysEnumerable.Select(__ => new string[] { _, __ }).ToArray(),
			Cube.Names.BalanceSheet => BalanceSheet.KeysEnumerable.Select(__ => new string[] { _, __ }).ToArray(),
			Cube.Names.CapitalAquisition => CapitalAquisition.KeysEnumerable.Select(__ => new string[] { _, __ }).ToArray(),
			Cube.Names.CapitalAquisitionV2 => CapitalAquisitionV2.KeysEnumerable.Select(__ => new string[] { _, __ }).ToArray(),
			Cube.Names.CashFlow => CashFlow.KeysEnumerable.Select(__ => new string[] { _, __ }).ToArray(),
			Cube.Names.CashFlowV2 => CashFlowV2.KeysEnumerable.Select(__ => new string[] { _, __ }).ToArray(),
			Cube.Names.ConditionalGrants => ConditionalGrants.KeysEnumerable.Select(__ => new string[] { _, __ }).ToArray(),
			Cube.Names.DemarcationChanges => DemarcationChanges.KeysEnumerable.Select(__ => new string[] { _, __ }).ToArray(),
			Cube.Names.FinancialPositionV2 => FinancialPosition.KeysEnumerable.Select(__ => new string[] { _, __ }).ToArray(),
			Cube.Names.GrantsV2 => Grants.KeysEnumerable.Select(__ => new string[] { _, __ }).ToArray(),
			Cube.Names.IncomeAndExpenditure => IncomeAndExpenditure.KeysEnumerable.Select(__ => new string[] { _, __ }).ToArray(),
			Cube.Names.IncomeAndExpenditureV2 => IncomeAndExpenditureV2.KeysEnumerable.Select(__ => new string[] { _, __ }).ToArray(),
			Cube.Names.Municipalities => Municipalities.KeysEnumerable.Select(__ => new string[] { _, __ }).ToArray(),
			Cube.Names.RepairsAndMaintenance => RepairsAndMaintenance.KeysEnumerable.Select(__ => new string[] { _, __ }).ToArray(),
			Cube.Names.RepairsAndMaintenanceV2 => RepairsAndMaintenanceV2.KeysEnumerable.Select(__ => new string[] { _, __ }).ToArray(),
			Cube.Names.UnauthorisedIrregularFruitlessAndWastefulExpenditure => UIFWExpenditure.KeysEnumerable.Select(__ => new string[] { _, __ }).ToArray(),

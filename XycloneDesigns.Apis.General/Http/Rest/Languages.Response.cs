...
namespace XycloneDesigns.Apis.General.Http.Rest
{
	...
	{
		public class Response : GeneralRest.Response<Language>
		{
			public Response() { }
			public Response(Request request, IQueryable<Language> queryable)
			{
			...
			public IQueryable<Language> Filter(Request request, IQueryable<Language> queryable)
			{

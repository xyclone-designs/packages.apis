...
namespace XycloneDesigns.Apis.General.Http.Rest
{
	public partial class GeneralRest 
	{
		public static class OrderKeys 
		{
			...
			public static IOrderedQueryable<TTable> Order<TTable>(IQueryable<TTable> queryable, string orderkey, bool reverse) where TTable : Tables._Table
			{
			...
			public static IQueryable<TTable> Order<TTable>(IQueryable<TTable> queryable, bool reverse, params string[] orderkeys) where TTable : Tables._Table
			{
